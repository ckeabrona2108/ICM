...
const STEPS: Step[] = [
  {
    ...
    title: "Регистрация",
    description:
      "Создайте аккаунт и получите доступ к личному кабинету артиста."
  },
  {
    icon: Upload,
    title: "Загрузка релиза",
    description:
      "Добавьте треки, обложку и заполните информацию о релизе."
  },
  {
    icon: Type,
    title: "Проверка",
    description:
      "Мы проверяем релиз и сообщаем, если что-то нужно исправить перед отправкой на площадки."
  },
  {
    icon: ShieldCheck,
    title: "Модерация",
    description:
      "После проверки релиз проходит необходимые этапы подготовки к публикации."
  },
  {
    icon: Rocket,
    title: "Публикация",
    description: "Музыка появляется на выбранных площадках в назначенную дату."
  },
  {
    icon: LineChart,
    title: "Статистика и выплаты",
    description:
      "Отслеживайте результаты релиза и управляйте доходом через личный кабинет."
  }
];
