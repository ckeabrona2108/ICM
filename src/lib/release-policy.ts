...
const trackSchema = z.object({
  ...
  versionDrugReference: z.boolean().optional(),
  aiAssistanceUsed: z.boolean().optional(),
  aiGeneratedFullTrack: z.boolean().optional(),
  aiGeneratedMusicOnly: z.boolean().optional(),
  aiGeneratedLyricsOnly: z.boolean().optional(),
  aiProcessedTrackOnly: z.boolean().optional(),
