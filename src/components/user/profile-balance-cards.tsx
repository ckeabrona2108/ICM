...
export function ProfileBalanceCards({
  ...
  royaltyBalance: number | null;
  royaltyBalanceError: string | null;
  ...
  return (
    <div className="mb-6 grid gap-4 md:grid-cols-3">
      <BalanceCard
        label="Роялти"
        value={royaltyBalance == null ? "—" : formatRubCurrency(royaltyBalance)}
        hint={royaltyBalanceError ?? "Доход от дистрибуции и выплат"}
      />
      <BalanceCard
        label="AI-токены"
...
function BalanceCard({
  ...
  return (
    <div className="ux-surface-soft rounded-[24px] p-4">
